...
Future<AcademicAbility> getAcademic() async {
  ...
  final response = await http.get(
    Uri.parse('https://d62c-45-188-17-163.ngrok-free.app/gateway/api/checks/active'),
    headers: {
...
class _AcademiaState extends State<Academia> {
  ...
  Future<String?> getCheckin() async {
    ...
    final dio = Dio();
    const url = 'https://d62c-45-188-17-163.ngrok-free.app/gateway/api/checks/resident/';
  ...
  Future<void> removeCheckin() async {
    ...
    final String? token = sharedPreferences.getString('token');
    final int? residentId = sharedPreferences.getInt('residentId');
    const url = 'https://d62c-45-188-17-163.ngrok-free.app/gateway/api/checks';
